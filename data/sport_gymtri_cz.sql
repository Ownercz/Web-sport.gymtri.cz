...
--
-- Struktura tabulky `authentication`
--
...
--
-- Vypisuji data pro tabulku `authentication`
--
...
CREATE TABLE IF NOT EXISTS `event_score` (
  ...
  `score_value` text,
  `score_points` text NOT NULL,
  `gender` text NOT NULL,
  `age` int(11) NOT NULL,
  `koeficient` text NOT NULL,
...
CREATE TABLE IF NOT EXISTS `points` (
  ...
  `score_points` text,
  PRIMARY KEY (`id`)
) ENGINE=InnoDB  DEFAULT CHARSET=utf8 COMMENT='Values...' AUTO_INCREMENT=99730 ;

--
-- Vypisuji data pro tabulku `points`
--

INSERT INTO `points` (`id`, `discipline_id`, `score_value`, `score_value_gender`, `score_points`) VALUES
(96793, 1, '0,0', 'F', '0'),
(96794, 1, '2,8', 'F', '200'),
(96795, 1, '2,9', 'F', '198'),
(96796, 1, '3,0', 'F', '196'),
