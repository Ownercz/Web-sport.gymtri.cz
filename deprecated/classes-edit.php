    ...
    if (isset($_GET['id']) && (!isset($_GET['delete']))) {
        ...
        echo "<div class='col-sm-4' style='float:right;'>
          <div class='list-group'>
            <a href='../app' class='list-group-item active'>
        ...
        <strong>Vymazáno!</strong> Nepodařená registrace tříd byla smazána, zahajte tuto registraci znova klepnuím <strong><a href='../app/classes/classes-add.php'>sem</a></strong>.
      </div>";
    } else {
        ...
        if ($row_cnt == 0) {
            ...
            while ($row = $result->fetch_array(MYSQLI_NUM)) {
                echo "<a href='?id=" . $row[3] . "' class='list-group-item'>Název: " . $row[1] . " Datum: " . $row[3] . "</a>";
            }
            echo "</div></form>";
        }
    }
