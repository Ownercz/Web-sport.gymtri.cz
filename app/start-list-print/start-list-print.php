...
tr:nth-child(even) td { background: #FEFEFE; border-bottom:1px solid black; }   

/* Cells in odd rows (1,3,5...) are another (excludes header cells)  */ 
tr:nth-child(odd) td { background: #FEFEFE; border-bottom:1px solid black;}  
...
<?PHP
     ...
     $request2="SELECT * From event_score where event_id = $id AND discipline_id = $discipline AND event_date = '$date';";
    ...
    <div class='page'>
        ...
        $request= "SELECT * From event_score where event_id = $id AND discipline_id = $discipline AND event_date = '$date';"  ; 
...
$i++;}
   ...
   V případě diskvalifikace přeškrtnout celý řádek.<br>Závodníci jsou připuštění ke startu za třídu pouze, pokud jsou v této startovní listině! <br>V případě náhradníka je nutné nejdříve tuto věc nahlásit u zpracování výsledků.
