...
<div class='container theme-showcase' role='main'>
    ...
    <div class='row'>
        <div class='col-md-12'>
            ...
            <div class='col-md-2'><strong>Začátek studia</strong></div>
            <br>
            <!--- <table class='table'>
              <thead>
                <tr>
            ...
            <form name="formatus" action="athletes-add-script.php" method="POST">
                ...
                <button type="submit" class="btn btn-primary" style="float:right"><i class="icon-user icon-white"></i>
                    Přidat atlety
                </button>
            </form>
    ...
    <button type="button" class="btn btn-lg btn-warning">Je nutné dodržet formát data! Např.
        "<?php echo date('d-m-Y'); ?>"<br/>Dodržte také formát třídy "B" bez číslovky a tečky !
    </button>
