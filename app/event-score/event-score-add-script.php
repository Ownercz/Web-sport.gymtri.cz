...
$request = "UPDATE event_score SET koeficient = $koeficient , score_value = $vykon, score_points = $points WHERE event_id = $id AND class_id = $class AND athlete_id = $athleteid;";
echo$request;
$result = $mysqli->query($request);
}
