...
if($sex == "M"){
    if( in_array( $vek , range( 10 , 12 ) ) ){$koeficient = 1.25; return $koeficient;}
    else if( in_array( $vek , range( 10 , 14 ) ) ){$koeficient = 1.06; return $koeficient;}
...
if($sex == "F"){
    if( in_array( $vek , range( 10 , 12 ) ) ){$koeficient = 1.15; return $koeficient;}
    else if( in_array( $vek , range( 13 , 14 ) ) ){$koeficient = 1.07; return $koeficient;}
